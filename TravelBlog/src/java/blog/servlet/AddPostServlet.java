...
//            out.println(part.getSubmittedFileName());
            Post p = new Post(pTitle, pContent, pContents, part.getSubmittedFileName(), null, cid, user.getId());
            PostDao dao = new PostDao(ConnectionProvider.getConnection());
            if (dao.savePost(p)) {

                String path = request.getRealPath("/") + "pic" + File.separator + part.getSubmittedFileName();
